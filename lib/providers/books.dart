...
class Books extends ChangeNotifier {
  ...
  Future<void> getSearchedBookData(
    ...
    var url = !_free
        ? 'https://www.googleapis.com/books/v3/volumes?q=${byTitleNotAuthor ? 'intitle' : 'inauthor'}:$searchString&maxResults=$_singleLoadBookCount&startIndex=$startIndex'
        : 'https://www.googleapis.com/books/v3/volumes?q=${byTitleNotAuthor ? 'intitle' : 'inauthor'}:$searchString&filter=free-ebooks&maxResults=$_singleLoadBookCount&startIndex=$startIndex';
